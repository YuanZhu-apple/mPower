//
//  YMLWalkingStepsViewController.m
//  Parkinson
//
...
@interface YMLWalkingStepsViewController ()
...
@implementation YMLWalkingStepsViewController
...
- (IBAction)switchPhaseDisplay:(id)sender
{
    ...
    if (selected == 0) {
        ...
        YMLWalkingResultsViewController  *controller = [[YMLWalkingResultsViewController alloc] initWithNibName:nil bundle:nil];
